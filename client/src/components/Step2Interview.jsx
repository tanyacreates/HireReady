...
const maleVideo = "/assets/videos/male-ai.mp4"
const femaleVideo = "/assets/videos/female-ai.mp4"
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='grid grid-cols-2 gap-6 text-center'>
              <div>
                ...
                <span className='text-xs text-gray-500'>Current Questions</span>
              </div>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
         ...
         {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
            ...
            className='mt-6 bg-indigo-50 border border-indigo-200 p-5 rounded-2xl shadow-sm'>
              <p className='text-indigo-600 font-medium mb-4'>{feedback}</p>
